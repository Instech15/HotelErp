        ...
        <div class="card flex-fill w-100">
            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        <div class="form-group mb-0">
                            <label class="font-weight-600 mb-0" id="total_charge"><?php echo number_format(round($totalamount*$totaldays),2,'.',','); ?></label>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="form-group mb-0">
                            ...
                            <div class="icon-addon addon-md">
                                ...
                                <input type="text" disabled class="form-control" id="totalamount"
                                    value="<?php echo round($totalamount*$totaldays); ?>" placeholder="Total amount">
                                <i
                                    class=""><?php if($currency->position==2){ echo html_escape($currency->curr_icon); } ?></i>
                            </div>
                        </div>
