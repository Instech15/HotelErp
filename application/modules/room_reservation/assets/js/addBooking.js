...
function getroomnumber(){
	...
	$("#discount").val(total);
	$("#offer").text(formatter.format(totaldiscount));
	$("#prdis").text(formatter.format(total));
	$("#prcharge").text(formatter.format(serviceCharge));
	$("#prtax").text(formatter.format(tax));
	$("#total").text(formatter.format(granttotal));
